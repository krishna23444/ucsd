...
bool Machine::ReadMem(int addr, int size, int *value)
{
  ...
  DEBUG('M', "Machine::ReadMem, addr=%d, physicalAddr=%d, size=%d, value=%d\n",
        addr, physicalAddress, size, *value);
...
bool Machine::WriteMem(int addr, int size, int value)
{
  ...
  DEBUG('M', "Machine::WriteMem, addr=%d, physicalAddr=%d, size=%d, value=%d\n",
        addr, physicalAddress, size, value);
  return TRUE;
}
