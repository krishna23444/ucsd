# This version of Parse::RecDescent.pm was copied from a Debian package.  The
# Debian package included this copyright notice:
#
...
#
#Upstream Author: Damian Conway <debian.to.damian@recursor.net>
#
#Copyright:
#
